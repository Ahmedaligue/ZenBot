...
${chalk.blueBright('┏━━━━━━━━━━━━━━━━━━━━━━━━━━')}
${chalk.blueBright('┃')} Usuario     : ${chalk.yellowBright(userName)}
${chalk.blueBright('┃')} Número      : ${chalk.cyanBright(sender.split('@')[0])}
${chalk.blueBright('┃')} Tipo        : ${chalk.magentaBright(isGroup ? 'Grupo' : 'Privado')}
${chalk.blueBright('┃')} Comando     : ${chalk.greenBright(command)}
